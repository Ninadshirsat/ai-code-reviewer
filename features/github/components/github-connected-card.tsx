...
import { GitHubIcon } from "@/features/auth/components/github-sign-form";
import { RiExternalLinkLine, RiPlugLine } from "@remixicon/react";
...
function DisconnectedActions({ installUrl }: { installUrl: string }) {
  return (
    ...
    >
      <GitHubIcon />
      Install GitHub App
      <RiExternalLinkLine className="size-3 opacity-80" />
    </Button>
  );
}
          ...
          <div className="flex items-start justify-between gap-4">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <CardDescription>
                  Install the AI Code reviewer app on your GitHub account or
